...
.schet{font-family:var(--zag);font-weight:600;font-size:118px;line-height:.92;
       letter-spacing:-.03em;margin:0}
.schet small{display:block;font-family:var(--osn);font-size:17px;font-weight:400;
             line-height:1.5;letter-spacing:0;margin-top:18px;color:#3b3f36;
             max-width:44ch}
...
ОПИСАНИЯ = [
    ...
    ("Вариант 3 — «Ведомость»", "Громкое место: цифра 55 000.",
     "Экран как складская ведомость: слева одна огромная цифра, справа таблица "
     "моноширинным. Ставка на ассортимент, а не на ширину. Подходит, если на "
     "созвоне окажется, что клиент продаёт именно охватом."),
]
