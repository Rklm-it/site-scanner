...
def zamerit(urls: list[str], skolko: int) -> None:
    ...
    # Пик вдвое больше итога: zip пакуется рядом с ещё не удалённой
    # распакованной выгрузкой, а jpeg не сжимается.
    print(f"  на томе нужно ≈ {itogo_mb * 2:.0f} МБ свободных, "
