...
# «отказ» и «мусор» — разные вещи. Отказ: компания живая, сейчас не надо —
# к такому возвращаются через пару месяцев. Мусор: лид негодный в принципе
# (сайт брошен, компания переехала, это агрегатор) — такой домен больше не
# показываем и в новых сканах не собираем.
STATUSES = ("", "написал", "звонил", "недозвон", "перезвонить", "интерес",
